# Alternative ways of estimating missing time to complete remission for Acute Myeloid Leukemia patients
This is the code for a mathematics bachelor's thesis at the university of Leiden. The thesis is titled 'Alternative ways of estimating missing time to complete remission for Acute Myeloid Leukemia patients' and is written by Rianne van der Linde in the spring of 2026. This project is supervised by prof. dr. Marta Fiocco. The code is implemented in an R Markdown environment. For most of the code a dataset is used, titled 't821_martanew.sav'. This dataset is not uploaded with the other files for privacy reasons. 
